...
package com.cdsoftware.lirion.structure.util;

import static com.cdsoftware.lirion.structure.test.util.RandomTestUtil.*;
import static com.cdsoftware.lirion.structure.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"com.cdsoftware.lirion.structure.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"com.cdsoftware.lirion.structure.util\"");
	}
