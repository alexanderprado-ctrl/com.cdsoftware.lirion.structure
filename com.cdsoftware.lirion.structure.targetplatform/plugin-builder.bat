...
call mvn validate -Didempiere.target=com.cdsoftware.lirion.structure.p2.targetplatform %DEBUG_MODE%
call mvn verify -Didempiere.target=com.cdsoftware.lirion.structure.p2.targetplatform %DEBUG_MODE%
