...
- New callout
    ...
    * Example: com.cdsoftware.lirion.structure.callout.CStringFormat

- New process
    * Name: PName
    * Package: com.cdsoftware.lirion.structure.process
    * Example: com.cdsoftware.lirion.structure.process.PGenerateWithholding

- New form
    * Name: FName
    * Package: com.cdsoftware.lirion.structure.form
    * Example: com.cdsoftware.lirion.structure.form.FMultiPayment

- New event
    * Name: EName
    * Package: com.cdsoftware.lirion.structure.event
    * Example: com.cdsoftware.lirion.structure.event.EAfterCompleteInvoice

- New model (extends class X)
    * Name: MName
    * Package: com.cdsoftware.lirion.structure.model
    * Example: com.cdsoftware.lirion.structure.model.MTableExample
...
```
    com.cdsoftware.lirion.structure
        ...
        |   |_ProcessFactory.xml
        |_src
            |_com.cdsoftware.lirion.structure
                |_base (plugin core)
...
- New callout
    * Create callout in package `com.cdsoftware.lirion.structure.callout`, extends from `CustomCallout`
    * Annotate it with the `@Callout` annotation at class level

- New process
    * Create process in package `com.cdsoftware.lirion.structure.process`, extends from `CustomProcess`
    * Annotate it with the `@Process` annotation at class level

- New form
    * Create form in package `com.cdsoftware.lirion.structure.form`, extends from `CustomForm`
    * Annotate it with the `@Form` annotation at class level

- New event
    * Create event in package `com.cdsoftware.lirion.structure.event`, extends from `CustomEvent`
    * Annotate it with the `@EventTopicDelegate` annotation at class level

- New model (extends form class X)
    * Create model in package `com.cdsoftware.lirion.structure.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
